    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed z-[10500] mt-2 w-[calc(100vw-24px)] sm:w-80 bg-theme-surface backdrop-blur-[6px] rounded-2xl p-0 border border-theme shadow-lg shadow-theme-main/20 overflow-hidden ring-1 ring-white/10 flex flex-col pointer-events-auto"
          style={{
            top: `${coords.top}px`,
